...
<body>
    ...
    <form action="uploadLab.php" method="POST" enctype="multipart/form-data">
        Nome: <input type="text" name="nome">
        1)Você gosta de estudar? <input type="text" name="p1">
        1)Você gosta de estudar? <input type="text" name="p2">
        1)Você gosta de estudar? <input type="text" name="p3">
